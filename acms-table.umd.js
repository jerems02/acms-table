        ...
        this.results.forEach(function (el) {
            ...
            el.items.forEach(function (item, index) {
                ...
                if (_this.colsSearchable.indexOf(index) > -1) {
                    ...
                    valueTemp += '';
                    if (valueTemp.indexOf(searchTerm) > -1) {
                        alreadyInList = true;
                        temp.push(el);
                    }
                }
