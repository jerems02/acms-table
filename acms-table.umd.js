(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/platform-browser'), require('@ngx-translate/core'), require('acms-switch')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/platform-browser', '@ngx-translate/core', 'acms-switch'], factory) :
	(factory((global['acms-table'] = {}),global.core,global.common,global.platformBrowser,global.core$1,global.acmsSwitch));
}(this, (function (exports,core,common,platformBrowser,core$1,acmsSwitch) { 'use strict';
...
var AcmsTableComponent = (function () {
    ...
    function AcmsTableComponent(_ref, _sanitizer) {
        ...
        this.emptyTableEvt = new core.EventEmitter();
        this.configRow = [];
        this.results = [];
        ...
        if (cell.target !== null && !cell.concat) {
            ...
            if (!objectFound) {
                ...
                if (cell.isMessageIfEmptyTranslatable)
                    translatable = true;
                if (cell.type === 'html')
                    objectFound = this._sanitizer.sanitize(core.SecurityContext.HTML, objectFound);
                if (cell.type === 'img')
                    objectFound = this._sanitizer.sanitize(core.SecurityContext.URL, objectFound);
                if (cell.type === 'url')
                    objectFound = this._sanitizer.sanitize(core.SecurityContext.URL, objectFound);
                if (cell.type === 'svg')
...
AcmsTableComponent.propDecorators = {
    ...
    'emptyTableEvt': [{ type: core.Output },],
};
